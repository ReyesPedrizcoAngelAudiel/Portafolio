  ...
  return (
    <section className="bg-primary mt-0 md:mt-12 text-white py-16 flex flex-col md:flex-row items-center justify-between gap-10">
      ...
      <div className="w-full md:w-7/12 text-center md:text-left relative">
        {/* Vertical Text */}
        <div className="absolute left-[40%] -top-6 md:-left-22 lg:top-0 md:top-6 rotate-0 md:rotate-[-90deg] text-sm tracking-widest">
        ...
        {/* Description */}
        <p className="text-gray-300 mb-6 text-sm md:text-[15px] leading-relaxed max-w-2xl mx-auto md:mx-0">
        ...
        {/* Buttons */}
        <div className="flex flex-col sm:flex-row gap-6 justify-between sm:justify-start">
          <a
            href=""
            onClick={(e) => {
              e.preventDefault();
            ...
            className="outline rounded-2xl outline-3 text-white font-semibold py-1 px-8 hover:bg-teal-500 hover:outline-none hover:scale-105 duration-300"
          >
            Volver
          </a>
          {/* Teléfono */}
          <p className="flex flex-row items-center gap-6 font-bold text-2xl text-teal-400 justify-center sm:justify-end sm:ml-55">
            427 - 289 - 5865
