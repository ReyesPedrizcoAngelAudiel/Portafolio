...
const Skills = ({ onHideSkills }) => {
  return (
    <section className="w-full py-16 md:px-8 xl:px-12 text-white bg-primary flex items-center scroll-snap-center">
      <div className="flex container flex-col md:flex-row items-center md:items-start gap-16 w-full">
        ...
        <div className="w-full md:w-1/2 relative p-6 sm:px-28 md:p-0">
          <div className="text-white p-6 pl-10 pr-20 sm:pl-10 lg:pr-20">
            {/* Vertical Text */}
            <div className="absolute -left-18 top-16 sm:-left-16 md:-left-20 xl:-left-28 md:top-16 xl:top-26 rotate-[-90deg] text-[14px] tracking-widest flex flex-row gap-1">
              <div className="xl:w-16 md:w-10 sm:w-8 w-8 h-[2px] bg-white mt-2 mx-auto"></div> {/*Linea*/}
              <p>Todas las habilidades</p>
            </div>

            {/* Main Heading */}
            <h2 className="text-3xl md:text-4xl xl:text-6xl font-bold leading-tight">
            Explora mi conjunto de tecnologías
            </h2>
          </div>

          <p className="text-gray-400 text-[16px] leading-relaxed">
            Estas son algunas de las librerias, 
            frameworks y lenguajes que uso en mi dia a dia. 
            Leal y comprometido con los resultados, trabajando de forma eficiente en cada proyecto.
          </p>
